INTERFACE zif_abapgit_aff_smbc_v1
  PUBLIC.
  CONSTANTS:
    "! <p class="shorttext synchronized">List Report Variant Management</p>
    ...
    "! <p class="shorttext synchronized">Object Page Variant Management</p>
    ...
    BEGIN OF co_selection_mode,
      ...
      "! <p class="shorttext synchronized">Select Single Entry</p>
