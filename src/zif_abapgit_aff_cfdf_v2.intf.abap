INTERFACE zif_abapgit_aff_cfdf_v2
  PUBLIC.
  ...
  TYPES ty_component_kind         TYPE c LENGTH 11.
  TYPES:
    "! <p class="shorttext">Labels and Tooltip</p>
    "! Labels and tooltip
    BEGIN OF ty_gs_ui_text,
      ...
      "! <p class="shorttext">Component Kind</p>
      "! Component kind
      "! $required
      "! $values {@link zif_aff_cfdf_v2.data:co_component_kind}
      "! $default {@link zif_aff_cfdf_v2.data:co_component_kind.main}
      component_kind       TYPE ty_component_kind,

      "! <p class="shorttext">Component Field Identifier</p>
      "! Component field identifier
      "! $required
      component_identifier TYPE c                 LENGTH 5,
      ...
      "! <p class="shorttext">Field Heading</p>
      "! Field heading
      "! $required
      field_heading        TYPE c                 LENGTH 55,

      "! <p class="shorttext">Field Medium Label</p>
      "! Field medium label
      field_medium_label   TYPE c                 LENGTH 20,

      "! <p class="shorttext">Field Short Label</p>
      "! Field short label
  ...
  TYPES ty_gt_extended_bus_context TYPE STANDARD TABLE OF ty_gs_extended_bus_context
        WITH KEY business_context.
  TYPES:
    ...
    BEGIN OF ty_gs_extended_cds_view,
      ...
      "! $values {@link zif_aff_cfdf_v2.data:co_field_control_property}
      "! $default {@link zif_aff_cfdf_v2.data:co_field_control_property.optional}
      field_control_property        TYPE ty_field_control_property,
    END OF ty_gs_extended_cds_view.
  TYPES ty_gt_extended_cds_view TYPE STANDARD TABLE OF ty_gs_extended_cds_view
        WITH KEY business_context cds_view_name.
  TYPES:
  ...
  TYPES ty_gt_extended_bus_scenario TYPE STANDARD TABLE OF ty_gs_extended_bus_scenario
        WITH KEY business_scenario.
  TYPES:
  ...
  TYPES:
    ...
    BEGIN OF ty_gs_extended_soap_service,
      ...
      "! Message direction
      "! $required
      "! $values {@link zif_aff_cfdf_v2.data:co_soap_message_direction}
      "! $default {@link zif_aff_cfdf_v2.data:co_soap_message_direction.request}
  ...
  TYPES ty_gt_code_list_value_descr TYPE STANDARD TABLE OF ty_gs_code_list_value_descr
        WITH KEY language code.
  TYPES:
  ...
  TYPES ty_gt_code_list_value TYPE STANDARD TABLE OF ty_gs_code_list_value
        WITH KEY code.
  TYPES:
  ...
  TYPES ty_gt_value_help_key_mapping TYPE STANDARD TABLE OF ty_gs_value_help_key_mapping
        WITH KEY component_identifier.
  TYPES:
  ...
  TYPES:
    ...
    BEGIN OF ty_gs_dpp_properties,
      ...
      "! Data subject
      "! $values {@link zif_aff_cfdf_v2.data:co_data_subject_id_type}
      "! $default {@link zif_aff_cfdf_v2.data:co_data_subject_id_type.not_applicable}
  ...
  TYPES:
    ...
    BEGIN OF ty_main,
      ...
      BEGIN OF type_details,
        ...
        "! Aggregation
        "! $values {@link zif_aff_cfdf_v2.data:co_aggregation}
        "! $default {@link zif_aff_cfdf_v2.data:co_aggregation.none}
  ...
  CONSTANTS:
    BEGIN OF co_component_kind,
      "! <p class="shorttext">Main</p>
      "! Main
      main        TYPE ty_component_kind VALUE 'MAIN',
      "! <p class="shorttext">Description</p>
      "! Description
      description TYPE ty_component_kind VALUE 'DESCRIPTION',
      "! <p class="shorttext">Reference</p>
      "! Reference
      reference   TYPE ty_component_kind VALUE 'REFERENCE',
    END OF co_component_kind.
ENDINTERFACE.
